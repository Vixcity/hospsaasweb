...
;(function ($) {
  ...
  var PrintArea = {
    ...
    write: function (PADocument, $ele) {
      PADocument.open()
      PADocument.write(
        PrintArea.docType() + '<html>' + PrintArea.getHead() + PrintArea.getBody($ele) + '</html>'
      )
      PADocument.close()
    },
    docType: function () {
    ...
    getFormData: function (ele) {
      ...
      $('input,select,textarea', ele).each(function (i) {
        ...
        if (typeInput == 'radio' || typeInput == 'checkbox') { copiedInput.attr('checked', $(this).is(':checked')) } else if (typeInput == 'text') copiedInput.attr('value', $(this).val())
